  ...
  return (
    <div className="curling-container">
      ...
      <section className="banner">
        <img
          src="https://storage.30shine.com/web/v4/images/uon/uon-tieu-chuan/banner_uon_tieu_chuan.jpg?v=5"
          alt="Uốn tiêu chuẩn chỉ từ 379K"
        />
      </section>
      ...
      <section className="basic-curling">
        ...
        <div className="curling-options">
          {basicCurlingOptions.map((option, index) => (
