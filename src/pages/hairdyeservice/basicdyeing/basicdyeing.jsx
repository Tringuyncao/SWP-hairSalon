  ...
  return (
    <div className="curling-container">
      ...
      <section className="banner">
        <img
          src="https://storage.30shine.com/web/v4/images/dich-vu-nhuom/chi-tiet/banner_chi_tiet_nhuom_tieu_chuan.jpg"
          alt="Nhuộm tiêu chuân chỉ từ 199K"
        />
      </section>
